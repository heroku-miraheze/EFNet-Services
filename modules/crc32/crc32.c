/*
**   IRC services crc32 module -- crc32.c
...
/*
** $Id: crc32.c,v 1.2 2004/03/30 22:23:45 cbehrens Exp $
*/
...
RCSID("$Id: crc32.c,v 1.2 2004/03/30 22:23:45 cbehrens Exp $");

static unsigned int _crc32_table[] = { /* CRC polynomial 0xedb88320 */
...
#define UPDC32(b, c) (_crc32_table[((int)(c) ^ (b)) & 0xff] ^ (((c) >> 8) & 0x00FFFFFFL))

crc32_t crc32_compute(register const char *string, size_t stringlen)
{
	register crc32_t		lcrc=0xFFFFFFFFL;
	register size_t			looper = stringlen;

	while(looper)
	{
		lcrc = UPDC32((u_char)*string, lcrc);
		looper--;
		string++;
	}
	return lcrc;
