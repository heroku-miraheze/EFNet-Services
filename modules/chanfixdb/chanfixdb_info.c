/*
**   IRC services chanfixdb module -- chanfixdb_info.c
...
RCSID("$Id: chanfixdb_info.c,v 1.2 2004/03/30 22:23:45 cbehrens Exp $");
...
int main(int argc, char **argv)
{
	...
	if (argc < 2)
	{
		fprintf(stderr, "Usage: chanfix_test filename\n");
		exit(-1);
	}
